      ...
      <section>
        ...
        <article className="article-base">
          <p>
            ...
            in Brazil, we coach our players so they develop their skills and
            knowledge of the beautiful game in a fun and uplifting environment
            in which mistakes are part of the learning process.
          </p>
          <p>
            Ousadia e Alegria (Boldness and Joy) is a Brazilian expression that
            defines what we seek: dare to try (new moves, dribbling past that
            difficult opponent, etc.) and play with joy. Using the same
            standards used by some of the biggest stars of SELEÇÃO BRASILEIRA DE
            FUTEBOL, the Brazilian National Team, our main focus is on
          ...
          <p>
            ...
            are. The Evolution will raise their self-esteem and confidence to
            perform at higher levels. We have players in more than 10 different
            top clubs in Southern California and there’s no conflict at all for
            us. We just want our athletes to improve.
          </p>
          ...
          <p>
            ...
            all, self-confidence, teamwork, responsibility, commitment, and
            patience. This is the foundation of our program.
          </p>
        </article>
        {/* <img className="coach-back" src="img/photos/coach-bg-none.png" alt="" /> */}
      </section>
    </main>
  );
}
